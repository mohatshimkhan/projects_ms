    ...
    <!--<li class="active treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('companies.index') }}"><i class="fa fa-circle-o"></i>Listings</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('projects.index') }}"><i class="fa fa-circle-o"></i> Projects List</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="{{ route('tasks.index') }}"><i class="fa fa-circle-o"></i> Tasks List</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
